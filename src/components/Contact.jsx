    ...
    <div className=" w-full pt-32">
      <div className="flex items-center flex-col justify-center">
        ...
        <div className="container rounded-3xl">
          <div className="flex  bg_contact h-80 w-full  lg:hidden relative  items-center justify-center">
            <div
              className=" absolute w-32 h-32 z-20 hidden lg:block"
              style={{ top: "50px", right: "-60px" }}
            >
            ...
            <div className="absolute z-20" style={{ top: "50px", left: "23%" }}>
        ...
        <p className=" text-xs text-white w-full text-center font-light py-8">
          © 2022 - Monster Sheltar, All right reserved.
        </p>
      </div>
    </div>
  );
